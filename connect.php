...
$sql = "CREATE TABLE IF NOT EXISTS flight (
    ...
    flight_no VARCHAR(10) NOT NULL,  -- Increased length for flexibility
...
// Create the view_details table if it doesn't exist
$sql = "CREATE TABLE IF NOT EXISTS view_details (
